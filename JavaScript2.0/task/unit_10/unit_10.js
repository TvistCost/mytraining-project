...
let ar2 = ['Привет', 'Иван', '27', true, false];// переменную обьявляем здесь!!!!
...
let ar3 = ['ilya', 33, true, false, 'Novograd-Volinskiy']; // переменную обьявляем здесь!!!!
...
let ar6 = ['ilya', 'lion', 'tuesday', 'august'];
