...
let e1 = '3', f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1; // строка с числом получается конкатенация
...
function t8() {
    ...
    let out = document.querySelector('.out-8'); // получили значение
    // тут выводим
    out.innerHTML = a;
}
...
function t12() {
    let a = document.querySelector('.i-12-1').value;
    let b = document.querySelector('.i-12-2').value;
    let out = document.querySelector('.out-12');
    out.innerHTML = 'Hello ' + a + ' ' + b;
}
...
function t14() {
    let a = document.querySelector('.i-14');
    a.value = 'Go';
}
