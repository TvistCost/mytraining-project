...
function t3(touch) {
  console.log(touch.srcElement.innerHTML);
  let a = touch.srcElement.innerHTML;
  if (a == "3-1") {
...
function t8() {
  ...
  document.querySelector(".div-8").style.background = rand;
}
...
function t10() {
  div10Width++;
  this.style.width = div10Width + "px";
}
...
function t11(e) {
  document.querySelector(
    ".out-11"
  ).textContent = `radiusX: ${e.touches[0].radiusX} px, radiusY: ${e.touches[0].radiusY} px`;
}
