...
function f5() {
	let out4 = document.querySelector('.out-4').classList.contains('bg-orange');
...
function f6() {
	...
	document.querySelector('.out-6').innerHTML = p.length;
}
...
function f13() {
	let d = document.createElement('div');
	d.innerHTML = 'pushMe';
	d.classList.add('bg-orange');
	d.onclick = f13_1;
	document.querySelector('.out-13').append(d);
}
...
function f14() {
	...
	d.innerHTML = 14;
	d.classList.add('bg-orange');
	document.querySelector('.out-14').append(d);
}
...
function f15() {
	...
	d.innerHTML = 15;
	d.classList.add('bg-orange');
	document.querySelector('.out-15').before(d);
}
...
function f16() {
	...
	d.innerHTML = 16;
	d.classList.add('bg-orange');
	document.querySelector('.out-16').after(d);
}
...
function f17() {
	...
	d.innerHTML = 17;
	d.classList.add('bg-orange');
	document.querySelector('.out-17').replaceWith(d);
}
